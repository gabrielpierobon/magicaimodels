...
if st.button('EXECUTE MODEL!'):
    ...
    try:
        ...
        st.error("Something went wrong. Check that you loaded a card correctly. You should provide a valid JSON, complete a card form or load a card from the database")
